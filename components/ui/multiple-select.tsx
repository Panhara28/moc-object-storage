        ...
        >
                  ...
                  >
                        ...
                        return (
                          ...
                          >
                            ...
                            <div
                              ...
                              className="ml-2 h-4 w-4 cursor-pointer hover:bg-white/20 rounded-sm !p-0 -m-0.5 focus:outline-none focus:ring-1 focus:ring-white/50"
                            >
                              <XCircle
                                className={cn(
                    ...
                    {selectedValues.length > responsiveSettings.maxCount && (
                      ...
                      >
                        ...
                        <XCircle
                          className={cn(
                            "ml-2 h-4 w-4 cursor-pointer text-red-500",
          ...
          <PopoverContent
            ...
            className={cn(
              ...
              screenSize === "desktop" && "min-w-[400px]",
              popoverClassName
            )}
            style={{
          ...
          >
            <Command>
              ...
              <div
                onWheel={(e) => {
                  e.stopPropagation(); // allows scroll wheel to work normally
                }}
                className={cn(
                  "max-h-[250px] overflow-y-auto multiselect-scrollbar",
                  screenSize === "mobile" && "max-h-[300px]",
                  screenSize === "tablet" && "max-h-[350px]"
                )}
              >
                <CommandList
                  className={cn(
                    "max-h-[250px] overflow-y-auto overscroll-contain multiselect-scrollbar",
                    screenSize === "mobile" && "max-h-[300px]",
                    screenSize === "tablet" && "max-h-[350px]"
                  )}
                  style={{
